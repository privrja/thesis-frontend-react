    ...
    render() {
        return (
            <span>
                ...
                <SelectInput id={this.props.id} name={this.props.name} options={OptionsHelper.modificationToOptions(this.props.modifications, this.props.defaultOption)} onChange={this.props.onChange} />
            </span>
        )
    }
