        ...
        return (
            <section className={styles.page}>
                <section className={styles.divLeft}>
                    ...
                    <h3>CycloBranch</h3>
                    <p><a href={'https://ms.biomed.cas.cz/cyclobranch'}>CycloBranch</a> is as program used in Mass Spectrometry developed by Jiří Novák.<br/>
                        DOI: <a href={'https://doi.org/10.1021/acs.analchem.0c00170'}>10.1021/acs.analchem.0c00170</a>
                    </p>

                    <h3>PubChem</h3>
                    <p><a href={'https://pubchem.ncbi.nlm.nih.gov'}>PubChem</a> is chemical database where use can search information about structures through MSB.<br/>
                    ...
                    <h3>Norine</h3>
                    <p><a href={'https://bioinfo.lifl.fr/norine/'}>Norine</a> is a chemical database used by MSB to search information.<br/>
                        DOI: <a href={'https://doi.org/10.1093/nar/gkm792'}>10.1093/nar/gkm792</a>
                    </p>

                    <h3>PDB</h3>
                    <p><a href={'https://www.rcsb.org'}>PDB</a> is a chemical database used by MSB to search information.<br/>
                    ...
                    <p>All documentation and info about MassSpecBlocks can be found on GitHub <a href={'https://github.com/privrja/MassSpecBlocks'}>https://github.com/privrja/MassSpecBlocks</a></p>
                </section>
            </section>
        );
    }
